    ...
    <main>
      ...
      <section id="services" className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-16 bg-gradient-to-r from-[#111] to-[#1a1226] border border-gray-800 rounded-xl p-8 md:p-10 flex flex-col md:flex-row items-center justify-between shadow-2xl relative overflow-hidden group">
            {/* Subtle background glow */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-purple-600 rounded-full mix-blend-multiply filter blur-3xl opacity-10 group-hover:opacity-20 transition-opacity duration-500"></div>
            
            <div className="mb-8 md:mb-0 md:pr-8 flex-1 relative z-10">
              <h3 className="text-2xl md:text-3xl font-bold mb-3">
                Already have a website?
              </h3>
              <p className="text-gray-300 text-lg mb-6 max-w-2xl">
                Add a targeted monthly maintenance plan to keep your site secure, updated, and running efficiently. Let me handle the technical details so you can focus on your business.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 text-sm text-gray-300">
                <span className="flex items-center"><span className="text-[var(--color-primary)] mr-2">✓</span> Regular Content Updates</span>
                <span className="flex items-center"><span className="text-[var(--color-primary)] mr-2">✓</span> Bug Fixes & Checking</span>
                <span className="flex items-center"><span className="text-[var(--color-primary)] mr-2">✓</span> SEO & Security Monitoring</span>
              </div>
            </div>
            
            <div className="flex flex-col items-center bg-[#0a0a0a] p-6 rounded-lg border border-purple-900/30 w-full md:w-auto min-w-[220px] relative z-10 hover:border-purple-500/50 transition-colors">
              <p className="text-3xl font-bold highlight mb-1">From $20</p>
              <p className="text-sm text-gray-500 mb-6 font-medium">per month</p>
              <Link href="/contact?service=Website%20Maintenance" className="btn btn-primary w-full text-center">
                Get Covered
              </Link>
            </div>
          </div>
